...
public class FillHBBillActivity extends MyBaseActivity {
    @Bind(R.id.sale_view)
    View sale_View;
    @Bind(R.id.main_view)
    View main_View;
    ...
    public void initViewData() {
        adapter = new DispatchAdapter(FillHBBillActivity.this, data);
        ...
        final LinearLayoutManager layoutManager = new LinearLayoutManager(FillHBBillActivity.this);
        ...
        adapter.setOnItemClickListener(new DispatchAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                Intent intent = new Intent(FillHBBillActivity.this, DispatchDetailActivity.class);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(FillHBBillActivity.this,DispatchActivity.class));
        finish();
    }
}
