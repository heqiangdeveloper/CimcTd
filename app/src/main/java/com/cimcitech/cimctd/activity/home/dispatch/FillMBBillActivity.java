...
public class FillMBBillActivity extends MyBaseActivity {
    @Bind(R.id.sale_view)
    View sale_View;
    @Bind(R.id.main_view)
    View main_View;
    ...
    public void initViewData() {
        adapter = new DispatchAdapter(FillMBBillActivity.this, data);
        ...
        final LinearLayoutManager layoutManager = new LinearLayoutManager(FillMBBillActivity.this);
        ...
        adapter.setOnItemClickListener(new DispatchAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                Intent intent = new Intent(FillMBBillActivity.this, DispatchDetailActivity.class);
