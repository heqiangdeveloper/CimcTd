...
public class CountDownTimerButton extends AppCompatButton implements View.OnClickListener{
    ...
    private Handler mHandler = new Handler(){
        ...
        public void handleMessage(Message msg) {
            CountDownTimerButton.this.setText(clickAfter + temp_duration/1000 + "s)");
            temp_duration -= 1000;
    ...
    private void startTimer(){
        ...
        CountDownTimerButton.this.setBackgroundColor(Color.GRAY);
        mTimer = new Timer();
        mTask = new TimerTask() {
            @Override
            public void run() {
