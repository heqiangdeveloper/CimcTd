...
public class MaintenancePlanVo{
    ...
    public MaintenancePlanVo(String isSendJobs, String isReceive, String isEnd, Long startDate,
                             Long endDate, Long contractId, Long custId,Long chargeId) {
